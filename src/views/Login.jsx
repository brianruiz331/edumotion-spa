...
export default function Login() {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    // Simulación simple para el trabajo académico
  ...
  return (
    <div className="py-16 px-4 max-w-md mx-auto">
      <div className="bg-white shadow-md border border-slate-200 rounded-2xl p-8">
        <h1 className="text-2xl font-extrabold text-slate-900 mb-6 text-center">Iniciar Sesión</h1>
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1">Correo (Usa "admin@..." para perfil administrador)</label>
            <input 
              type="email" 
              required 
              value={email}
